...
```{r map-sites-static, results = "hide"}
library(mermaidreporting)
...
```{r, map-sites-by-management_rules, results = "hide"}
xpdc_fishbelt %>%
  mermaid_clean_management_rules() %>%
...
```{r plot-fish-family-biomass-management-rules, results = "hide"}
xpdc_fishbelt %>%
...
```{r plot-fish-family-biomass-reef-zone, results = "hide"}
xpdc_fishbelt %>%
