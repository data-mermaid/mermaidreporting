...
```{r, map-sites-by-management_rules, eval = FALSE}
xpdc_fishbelt %>%
  mermaid_clean_management_rules() %>%
...
```{r plot-fish-family-biomass-management-rules, eval = FALSE}
xpdc_fishbelt %>%
...
```{r plot-fish-family-biomass-reef-zone, eval = FALSE}
xpdc_fishbelt %>%
